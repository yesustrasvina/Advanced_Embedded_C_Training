...
![Advanced Embbedded C Training Badge](https://github.com/yesustrasvina/Advanced_Embedded_C_Training/blob/main/Images/Embedded_C_Badge.png)
...
```
Project/Part_4_Clock_and_Calendar
    queue.h
    queue.c
    scheduler.h
    scheduler.c
